...
rf=$2
R_TYPE=$3
#inputPath="/home/antonio/Dropbox/Artigos_Conferencias/Papers/RelaxometryMRI/brainweb-relaxometry"


#if [ $# -eq 0 ];
#then
#echo "Missing parameters."
#echo "Usage: <noise intensity (0, 3 or 9)> <rf (0, 20 or 40)> <Remove hard segmentation?>"
#exit
#fi
...
#fsl5.0-fast -t 1 -n 3 -H 0.1 -I 4 -l 20.0 -g -o "data/"${R_TYPE}"/"${sufix}"/brainweb_"$sufix"_brain" "data/"${R_TYPE}"/"$sufix"/brainweb_"$sufix"_brain"
